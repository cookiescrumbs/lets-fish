  ...
  private
    ...
    def fishery_params
       params.require(:fishery).permit(:name, :contact_name, :street, :line2, :region, :country, :postcode, :telephone, :mobile, :email, :lat_lng, :description, :prices, :record, :season, :facilities, :species_ids => [],:insect_ids => [])
    end
end
