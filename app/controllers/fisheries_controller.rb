  ...
  private
    ...
    def fishery_params
       params.require(:fishery).permit(:name, :contact_name, :street, :line2, :region, :country, :postcode, :telephone, :email, :lng, :lat, :description, :prices, :record, :species_ids => [],:insect_ids => [])
    end
end
